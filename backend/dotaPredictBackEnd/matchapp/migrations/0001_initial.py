    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_status', models.CharField(choices=[('draft_to_start', 'Draft to start'), ('draft_in_progress', 'Draft in progress'), ('draft_finished', 'Draft finished'), ('match_ended', 'Match ended')], default='draft_to_start', max_length=50)),
